...
fun DetailGrid(
    ...
    Column(
        ...
        Row {
            DetailItem(painterResource(R.drawable.ic_feels), "Feels like", current.feelsLike!!.toTemperature())
            VerticalDivider()
            DetailItem(painterResource(R.drawable.ic_wind), "Wind Speed", current.windSpeed!!.toSpeed())
            VerticalDivider()
        ...
        Row {
            ...
            VerticalDivider()
            DetailItem(painterResource(R.drawable.ic_pressure), "Pressure", current.pressure!!.toPressure())
        }
        HorizontalDivider()
        Row {
            DetailItem(painterResource(R.drawable.ic_humidity), "Humidity", current.humidity!!.toHumidity())
            VerticalDivider()
            DetailItem(painterResource(R.drawable.ic_dew), "Dew point", current.dewPoint!!.toDewPoint())
            VerticalDivider()
